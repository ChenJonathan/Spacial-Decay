...
public class SplitEnemyMed : Enemy
{
    ...
    public override void Start()
    {
        ...
        GetComponent<Rigidbody2D>().velocity = direction / direction.magnitude * (4 + Difficulty);
        ...
        fireData.WithModifier(new CircularBurstModifier(45, 4 + Difficulty, 0, 0));
        burstNum += Difficulty;
    }
